export function Hero() {
  return (
    <section
          id="inicio"
          className="mx-auto grid min-h-[calc(100vh-96px)] max-w-[1750px] gap-10 px-6 py-10 md:grid-cols-2 md:items-center"
        >
          <div>
            ...
            <h1 className="max-w-2xl text-4xl font-black leading-tight md:text-[81px]">
              ...
              <span className="inline-block bg-lime-400 px-3 text-black">
                soluções
              </span>{" "}
              digitais escaláveis
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#projetos"
                className="inline-flex items-center justify-center rounded-md bg-lime-400 px-6 py-4 text-sm font-bold text-black transition hover:bg-lime-300">
                ver projetos
              </a>

              <a
                href="/curriculo.pdf"
                className="inline-flex items-center justify-center rounded-md border border-zinc-700 px-6 py-4 text-sm font-bold text-white transition hover:border-lime-400 hover:text-lime-400">
                ver currículo
              </a>
            </div>
          </div>

          <div className="relative min-h-[520px] overflow-hidden rounded-lg border border-zinc-800 bg-zinc-950">
